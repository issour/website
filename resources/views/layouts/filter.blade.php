        ...
        <div class="w-1/5">
            <div class="w-full relative flex">
                ...
                <form action="{{ request()->url() }}">
                    <input type="search" placeholder="Search workflows" name="search" value="{{ request('search') }}" class="block w-full border border-transparent bg-white focus:outline-none  focus:border-gray-300 text-gray-900 rounded-lg pl-12 pr-4 py-2">
                </form>
            </div>
        </div>
